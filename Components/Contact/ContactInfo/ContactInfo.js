...
const ContactInfo = (props) => {
  ...
  const { GENERAL, TABLES, TEXT, DIMENSIONS, SPACING } = styles;
  const {
    centerAll,
    mediumWidth,
    smallBasicPadding,
  ...
  const mainClasses = useClass([centerAll, mediumWidth]);
  const secondaryClass = useClass([lgPX, lgPY]);
